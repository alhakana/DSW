...
public abstract class ApplicationFramework {
	...
	/**
	 * Inicijalizuje atribute.
	 */
	public void initialise(Gui gui, Repository repository, EventHandlerInterface eventHandler, SerializationHandlerInterface serializationHandler, FileUtilHandler fileUtilHandler, SlotHandler slotHandler, ActionManager actionManager) {
		this.gui = gui;
